...
class Wiki {
	...
	**/
	...
	/**
	 * Write the result of a previous query to a log at Wiki page.
	...
	function write_log($result,$page){
		...
		foreach($result as $get_result){
			...
			$get_result = $get_result['edit'];
			if($get_result['result'] != "Success") break;
			
			$content_log .= '* [[:' . $get_result['title'] .']]' . PHP_EOL;
		}
